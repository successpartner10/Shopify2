...
Privacy-first Shopify admin live scanner. **v3.6.8** · 21 August 2026.

| | |
|---|---|
| **GitHub Pages** | https://successpartner10.github.io/Shopify2/?v=3.6.8 |
| **Cloudflare Worker** | https://shopify2.panchgani2025.workers.dev/?v=3.6.8 |
| **Cloudflare Pages** | https://storescope-cwl.pages.dev/?v=3.6.8 (still old 1.x until Git reconnect — [DEPLOY.md](./DEPLOY.md)) |
...
| Purpose | URL |
|---|---|
| Open the app | https://successpartner10.github.io/Shopify2/?v=3.6.8 |
| Worker mirror | https://shopify2.panchgani2025.workers.dev/?v=3.6.8 |
| Original Pages host | https://storescope-cwl.pages.dev/?v=3.6.8 |
| Shared playbook | `https://successpartner10.github.io/Shopify2/?v=3.6.8&fix=error-payout-hold-banner` |
| Typed search | `https://successpartner10.github.io/Shopify2/?v=3.6.8&q=klarna` |
| Home-screen shortcut (upload) | `https://successpartner10.github.io/Shopify2/?v=3.6.8&action=upload` |
| Privacy | https://successpartner10.github.io/Shopify2/privacy.html |

`?v=3.6.8` cache-busts CSS/JS and the service worker (`storescope-v3.6.8`). Hard-refresh if an old build is stuck.
...
1. Open https://successpartner10.github.io/Shopify2/?v=3.6.8 as a **top-level tab**.
...
Logo and title now say the real version. Fixed a broken line at the end of `app.js` that stopped the app from starting (so the page stayed on 3.6.6 and topics did not open).

### 2026-08-21, v3.6.7

Topic tiles stay visible and each button is bound. Incomplete pin pass — HTML still said 3.6.6.
...
| Piece | Value |
|---|---|
| App | `3.6.8` (`js/version.js`) |
| Service worker | `storescope-v3.6.8` |
| Public query | `?v=3.6.8` on HTML, CSS, JS, manifest, shortcuts |
...
## 14. Functionality checklist (v3.6.8)
