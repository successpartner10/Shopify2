...
Privacy-first Shopify admin live scanner. **v2.9.0** · 19 August 2026.

| | |
|---|---|
| **GitHub Pages** | https://successpartner10.github.io/Shopify2/?v=2.9.0 |
| **Cloudflare Worker** | https://shopify2.panchgani2025.workers.dev/?v=2.9.0 |
| **Cloudflare Pages** | https://storescope-cwl.pages.dev/?v=2.9.0 (still old 1.x until Git reconnect — [DEPLOY.md](./DEPLOY.md)) |
| **Source** | https://github.com/successpartner10/Shopify2 |
| **Offline package** | [storescope-offline.zip](https://github.com/successpartner10/Shopify2/releases/download/v2.9.0/storescope-offline.zip) |
...
| Purpose | URL |
|---|---|
| Open the app | https://successpartner10.github.io/Shopify2/?v=2.9.0 |
| Worker mirror | https://shopify2.panchgani2025.workers.dev/?v=2.9.0 |
| Original Pages host | https://storescope-cwl.pages.dev/?v=2.9.0 |
| Shared playbook | `https://successpartner10.github.io/Shopify2/?v=2.9.0&fix=error-payout-hold-banner` |
| Typed search | `https://successpartner10.github.io/Shopify2/?v=2.9.0&q=payouts%20on%20hold` |
| Home-screen shortcut (upload) | `https://successpartner10.github.io/Shopify2/?v=2.9.0&action=upload` |
| Privacy | https://successpartner10.github.io/Shopify2/privacy.html |

`?v=2.9.0` cache-busts CSS/JS and the service worker (`storescope-v2.9.0`). Hard-refresh if an old build is stuck.
...
1. Open https://successpartner10.github.io/Shopify2/?v=2.9.0 as a **top-level tab**.
...
1. Download [storescope-offline.zip](https://github.com/successpartner10/Shopify2/releases/download/v2.9.0/storescope-offline.zip).
2. Unzip.
...
## 10. Audit log (2026-08-19, v2.9.0)
...
| Diagnostic export still said `2.0.0` | `2.9.0` |
| History / flow HTML could render raw objects | Escaped + string steps |
| Shopify app docs still said `?v=2.6.0` | `?v=2.9.0` |
| Offline zip pointed at the v2.1.0 release | v2.9.0 release |
...
| Piece | Value |
|---|---|
| App | `2.9.0` (`js/version.js`) |
| Service worker | `storescope-v2.9.0` |
| Public query | `?v=2.9.0` on HTML, CSS, JS, manifest, shortcuts |
