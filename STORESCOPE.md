...
Privacy-first Shopify admin live scanner. **v3.3.1** · 20 August 2026.

| | |
|---|---|
| **GitHub Pages** | https://successpartner10.github.io/Shopify2/?v=3.3.1 |
| **Cloudflare Worker** | https://shopify2.panchgani2025.workers.dev/?v=3.3.1 |
| **Cloudflare Pages** | https://storescope-cwl.pages.dev/?v=3.3.1 (still old 1.x until Git reconnect — [DEPLOY.md](./DEPLOY.md)) |
| **Source** | https://github.com/successpartner10/Shopify2 |
| **Offline package** | [storescope-offline.zip](https://github.com/successpartner10/Shopify2/releases/download/v3.3.1/storescope-offline.zip) |
...
| Purpose | URL |
|---|---|
| Open the app | https://successpartner10.github.io/Shopify2/?v=3.3.1 |
| Worker mirror | https://shopify2.panchgani2025.workers.dev/?v=3.3.1 |
| Original Pages host | https://storescope-cwl.pages.dev/?v=3.3.1 |
| Shared playbook | `https://successpartner10.github.io/Shopify2/?v=3.3.1&fix=error-payout-hold-banner` |
| Typed search | `https://successpartner10.github.io/Shopify2/?v=3.3.1&q=klarna` |
| Home-screen shortcut (upload) | `https://successpartner10.github.io/Shopify2/?v=3.3.1&action=upload` |
| Privacy | https://successpartner10.github.io/Shopify2/privacy.html |

`?v=3.3.1` cache-busts CSS/JS and the service worker (`storescope-v3.3.1`). Hard-refresh if an old build is stuck.
...
1. Open https://successpartner10.github.io/Shopify2/?v=3.3.1 as a **top-level tab**.
...
1. Download [storescope-offline.zip](https://github.com/successpartner10/Shopify2/releases/download/v3.3.1/storescope-offline.zip).
2. Unzip.
...
| Piece | Value |
|---|---|
| App | `3.3.1` (`js/version.js`) |
| Service worker | `storescope-v3.3.1` |
| Public query | `?v=3.3.1` on HTML, CSS, JS, manifest, shortcuts |
