...
3. **App URL** (standalone):  
   `https://successpartner10.github.io/Shopify2/?v=2.6.0`  
...
8. Privacy policy page (public URL). Can be a `/privacy` page on the same host.
...
| `GET /auth/callback` | Exchange code, then redirect to `/?v=2.6.0&shop=…` |
