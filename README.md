...
- **Live (this build):** https://successpartner10.github.io/Shopify2/
- **Legacy Cloudflare URL:** https://storescope-cwl.pages.dev/ — still the old 1.x app until you reconnect it ([DEPLOY.md](./DEPLOY.md))
