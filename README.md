...
| Host | URL |
|---|---|
| **GitHub Pages** (source of truth) | https://successpartner10.github.io/Shopify2/?v=3.2.0 |
| **Cloudflare Worker** | https://shopify2.panchgani2025.workers.dev/?v=3.2.0 |
| **Cloudflare Pages** | https://storescope-cwl.pages.dev/?v=3.2.0 — still the old 1.x until you reconnect Git; see [DEPLOY.md](./DEPLOY.md) |
| **Source** | https://github.com/successpartner10/Shopify2 |
| **Offline zip** | [GitHub Release v3.2.0](https://github.com/successpartner10/Shopify2/releases/tag/v3.2.0) |
