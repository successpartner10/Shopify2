...
| Host | URL |
|---|---|
| **GitHub Pages** (source of truth) | https://successpartner10.github.io/Shopify2/?v=3.6.4 |
| **Cloudflare Worker** | https://shopify2.panchgani2025.workers.dev/?v=3.6.4 |
| **Cloudflare Pages** | https://storescope-cwl.pages.dev/?v=3.6.4 — still the old 1.x until you reconnect Git; see [DEPLOY.md](./DEPLOY.md) |
