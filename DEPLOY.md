...
| Host | Status at v3.3.1 |
|---|---|
| **GitHub Pages** | Live: https://successpartner10.github.io/Shopify2/?v=3.3.1 |
| **Cloudflare Worker** `shopify2` | Should follow `main` via Workers Builds: https://shopify2.panchgani2025.workers.dev/?v=3.3.1 |
...
When it finishes, https://storescope-cwl.pages.dev/?v=3.3.1 should show **v3.3.1** under the logo and the home line “What’s wrong in Shopify?”.
