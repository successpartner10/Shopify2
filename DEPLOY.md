...
| Host | Status at v2.7.3 |
|---|---|
| **GitHub Pages** | Live: https://successpartner10.github.io/Shopify2/?v=2.7.3 |
| **Cloudflare Worker** `shopify2` | Should follow `main` via Workers Builds: https://shopify2.panchgani2025.workers.dev/?v=2.7.3 |
...
When it finishes, https://storescope-cwl.pages.dev/?v=2.7.3 should show **v2.7.3** under the logo and the home line “What’s wrong in Shopify?”.
...
`https://successpartner10.github.io/Shopify2/?v=2.7.3`

or, once the Worker is on this build:

`https://shopify2.panchgani2025.workers.dev/?v=2.7.3`
