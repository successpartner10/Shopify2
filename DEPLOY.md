...
| Host | Status at v3.6.8 |
|---|---|
| **GitHub Pages** | Live: https://successpartner10.github.io/Shopify2/?v=3.6.8 |
| **Cloudflare Worker** `shopify2` | Should follow `main` via Workers Builds: https://shopify2.panchgani2025.workers.dev/?v=3.6.8 |
...
When it finishes, https://storescope-cwl.pages.dev/?v=3.6.8 should show **v3.6.8** under the logo and the home line “What’s wrong in Shopify?”.
...
`https://successpartner10.github.io/Shopify2/?v=3.6.8`

or, once the Worker is on this build:

`https://shopify2.panchgani2025.workers.dev/?v=3.6.8`
