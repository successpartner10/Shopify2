...
| Host | Status at v3.3.0 |
|---|---|
| **GitHub Pages** | Live: https://successpartner10.github.io/Shopify2/?v=3.3.0 |
| **Cloudflare Worker** `shopify2` | Should follow `main` via Workers Builds: https://shopify2.panchgani2025.workers.dev/?v=3.3.0 |
...
When it finishes, https://storescope-cwl.pages.dev/?v=3.3.0 should show **v3.3.0** under the logo and the home line “What’s wrong in Shopify?”.
